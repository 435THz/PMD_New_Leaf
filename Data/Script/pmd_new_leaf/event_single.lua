...
function SINGLE_CHAR_SCRIPT.TutorialScriptDungeon(owner, ownerChar, context, args)
	if context.User == nil then
		UI:ResetSpeaker()
		if args.Floor > SV.Intro.DungeonTutorialProgress and args.Floor <= 1 then
		...
		if args.Floor > SV.Intro.DungeonTutorialProgress and args.Floor <= 2 then
			SOUND:PlayFanfare("Fanfare/Note")
		...
		if args.Floor > SV.Intro.DungeonTutorialProgress and args.Floor <= 3 then
			SOUND:PlayFanfare("Fanfare/Note")
		...
		if args.Floor > SV.Intro.DungeonTutorialProgress and args.Floor <= 4 then
		...
		if args.Floor > SV.Intro.DungeonTutorialProgress and args.Floor <= 5 then
			SOUND:PlayFanfare("Fanfare/Note")
		...
		if args.Floor > SV.Intro.DungeonTutorialProgress and args.Floor <= 6 then
			SOUND:PlayFanfare("Fanfare/Note")
		...
		if args.Floor > SV.Intro.DungeonTutorialProgress and args.Floor <= 7 then
			SOUND:PlayFanfare("Fanfare/Note")
